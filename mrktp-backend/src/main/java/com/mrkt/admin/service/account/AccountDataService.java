...
import com.mrkt.admin.model.account.MrktpAccountdataBaseEntity;
...
@Getter
@Setter
public abstract class AccountDataService<E extends MrktpAccountdataBaseEntity, D extends MrktpBaseDto>
        implements MrktpAccountBaseService<E,D> {
